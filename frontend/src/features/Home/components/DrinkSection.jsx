...
const DrinkSection = ()=>{
  ...
  return(
    ...
    <section className="drink-section-bottom bg-[#B16CDF] md:h-screen h-[70vh]">
      <div className="h-full w-full flex md:flex-row flex-col justify-center items-center">
       ...
       <div className="md:h-full h-1/2 md:w-1/2 w-full flex justify-center items-center md:justify-start p-5 ">
        ...
        <div className="md:h-full h-1/2 md:w-1/2 w-full flex justify-center items-center p-5">
          <h2 className="md:text-[60px] lg:text-[80px] text-[30px] w-full h-full text-white  font-medium flex justify-center items-center text-center">ALT-CO DRINKS<br/> ARE  BEST AND NATURAL</h2>
        </div>
      </div>
    </section>
