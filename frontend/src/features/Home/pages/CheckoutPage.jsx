    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-sm bg-white rounded-xl shadow-2xl overflow-hidden animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="bg-white min-h-[300px]">
          {step === "methods" && (
            <div>
              <p className="px-5 py-3 text-xs font-bold text-stone-400 uppercase tracking-wider">
                Payment Methods
              </p>

              <button
                onClick={() => handlePay("upi")}
                className="w-full flex items-center gap-4 px-5 py-4 hover:bg-stone-50 border-b border-stone-100 transition"
              >
              ...
              <button
                ...
                className="w-full flex items-center gap-4 px-5 py-4 hover:bg-stone-50 transition"
              >
                <div className="w-10 h-10 border border-stone-200 rounded flex items-center justify-center bg-white text-stone-400">
                  <svg
                    className="w-6 h-6"
          ...
          {step === "processing" && (
            <div className="flex flex-col items-center justify-center h-[300px] text-center px-6">
              ...
              <h3 className="text-stone-900 font-black text-lg mb-1">
                Processing Payment
              </h3>
          ...
          {step === "success" && (
            <div className="flex flex-col items-center justify-center h-[300px] text-center px-6">
              ...
              <h3 className="text-green-600 font-black text-xl mb-1">
                Payment Successful
              </h3>
    ...
    <div className="min-h-screen bg-white relative">
      ...
      {loading && !showRazorpay && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-white/80 backdrop-blur-sm">
          <svg
            className="w-16 h-16 text-amber-400 animate-spin mb-4"
            fill="none"
            viewBox="0 0 24 24"
          >
            <circle
