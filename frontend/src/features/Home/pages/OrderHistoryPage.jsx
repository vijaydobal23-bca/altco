...
const api = axios.create({
  baseURL: "https://altco-1.onrender.com/api",
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="space-y-4">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <p className="text-blue-200 font-bold text-xs uppercase tracking-[0.2em]">
                          Delivery Details
                        </p>
                      </div>
                      ...
                      <div className="bg-white/5 border border-white/10 rounded-2xl p-5 backdrop-blur-sm hover:bg-white/10 transition-colors flex flex-col justify-between h-full">
                        <div className="flex justify-between items-start mb-4">
                          ...
                          <div className="text-right">
                            ...
                            <p
                              className={`font-black text-xs uppercase tracking-widest ${order.paymentStatus === "PAID" ? "text-emerald-300" : "text-amber-300"}`}
                            >
                              {order.paymentStatus}
                            </p>
                          </div>
                              ...
                              <div className="w-full h-full flex items-center justify-center">
                                ...
                                >
                                  <path
                                    strokeLinecap="round"
                                    strokeLinejoin="round"
                                    d="M2.25 15.75l5.159-5.159a2.25 2.25 0 013.182 0l5.159 5.159m-1.5-1.5l1.409-1.409a2.25 2.25 0 013.182 0l2.909 2.909M3 20.25h18"
                                  />
                                </svg>
                              </div>
                            )}
